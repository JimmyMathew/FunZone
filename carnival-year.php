			...
			<section class="ftco-section-2">
				<div class="photograhy HomePhotography">
					...
					<div class="col-md-4 ftco-animate">
							<a href="carnival-videos.php" class="photography-entry img  d-flex justify-content-center align-items-center" style="background-image: url(images/image_6.jpg);">
						...
						<div class="col-md-4 ftco-animate">
							<a href="carnival-2019.php" class="photography-entry img  d-flex justify-content-center align-items-center" style="background-image: url(images/image_1.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>2019</h3>
									<!-- <span class="tag">Model</span> -->
